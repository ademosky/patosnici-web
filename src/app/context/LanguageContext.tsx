...
const mk = {
  ...
  // Auto accessories benefits
  acc_practical: "Практичен и компактен",
  acc_car: "Идеален за автомобил",
  acc_daily: "За секојдневни работи",
  acc_stable: "Стабилен при возење",
  acc_clean: "Лесен за чистење",
  acc_delivery: "Достава низ Македонија",
  ...
  form_email: "Email",
  form_note: "Напомена",
  form_note_opt: "опционално",
  form_name_ph: "Марко",
  form_surname_ph: "Петровски",
  form_address_ph: "ул. Македонија бр. 12",
  form_city_ph: "Скопје",
  form_phone_ph: "+389 70 123 456",
  form_note_ph: "Пр. достава наутро, достава на одреден датум...",
  ...
  no_results_msg: "Не пронајдовме производи за",
  back_all_products: "Сите производи",
...
const sq: typeof mk = {
  ...
  acc_practical: "Praktik dhe kompakt",
  acc_car: "Ideal për automjet",
  acc_daily: "Për punë të përditshme",
  acc_stable: "I qëndrueshëm gjatë vozitjes",
  acc_clean: "I lehtë për pastrim",
  acc_delivery: "Dërgesë në gjithë Maqedoninë",
  ...
  // Form fields
  form_name: "Emri",
  form_surname: "Mbiemri",
  form_address: "Adresa",
  form_city: "Qyteti",
  form_phone: "Telefoni",
  form_email: "Email",
  form_note: "Shënim",
  form_note_opt: "opsionale",
  form_name_ph: "Burim",
  form_surname_ph: "Berisha",
  form_address_ph: "Rr. Nëna Terezë 12",
  form_city_ph: "Prishtinë",
  form_phone_ph: "+383 44 123 456",
  form_note_ph: "Shënim për porosinë...",
  ...
  search_results_for: "Rezultatet për",
  no_products: "Nuk ka produkte",
  no_results_msg: "Nuk gjetëm produkte për",
  back_all_products: "Të gjitha produktet",
