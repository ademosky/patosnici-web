...
export default function TrustBar() {
  ...
  return (
    <section className="bg-[#111111] border-y border-zinc-800 py-10 sm:py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-6 md:grid-cols-2 lg:grid-cols-4">
          {items.map((item) => {
            ...
            return (
              <div key={item.title} className="rounded-xl border border-zinc-800 bg-[#171717] p-4 sm:p-6 text-center transition hover:border-red-600">
