      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 md:grid-cols-3">
          ...
          <div>
            ...
            <p className="mt-5 text-sm leading-7 text-zinc-400">
              Оригинални гумени патосници за сите марки возила.
              Изработени со прецизност за совршено пасување.
            </p>
            ...
            <div className="mt-6 flex items-center gap-3">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-xl border border-zinc-800 text-zinc-400 transition hover:border-red-600 hover:text-red-500"
                aria-label="Facebook"
              >
              ...
              <a
                href="https://www.instagram.com/patosnici?igsh=dW0yZTdvYWFicXY5"
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-xl border border-zinc-800 text-zinc-400 transition hover:border-red-600 hover:text-red-500"
          ...
          <div>
            ...
            <div className="mt-5">
              <a
                ...
                className="flex items-center gap-3 text-sm text-zinc-400 transition hover:text-red-500"
              >
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-zinc-800 pt-8 sm:flex-row">
          <p className="text-xs text-zinc-600">
            © {new Date().getFullYear()} Original Patosnici. Сите права задржани.
          </p>
          <p className="text-xs text-zinc-700">
            Оригинални гумени патосници — Македонија
          </p>
        </div>
      </div>
    </footer>
